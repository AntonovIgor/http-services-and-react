        ...
        return (
            <section className="notice">
                ...
                <fieldset className="ad-form-header">
                    ...
                    <div className="ad-form-header__upload">
                        ...
                        <div className="ad-form__field">
                            ...
                            <label className="ad-form-header__drop-zone" for="avatar">Загрузите или&nbsp;перетащите сюда фото</label>
                        </div>
                ...
                <fieldset className="ad-form__element ad-form__element--wide">
                    <label className="ad-form__label" for="title">Заголовок объявления</label>
                    <input id="title" name="title" type="text" placeholder="Милая, уютная квартирка в центре Токио" />
                </fieldset>
                <fieldset className="ad-form__element ad-form__element--wide">
                    <label className="ad-form__label" for="address">Адрес</label>
                    <input id="address" name="address" type="text" />
                </fieldset>
                <fieldset className="ad-form__element">
                    <label className="ad-form__label" for="type">Тип жилья</label>
                ...
                <fieldset className="ad-form__element">
                    <label className="ad-form__label" for="price">Цена за ночь, руб.</label>
                    <input id="price" name="price" type="number" placeholder="5000" />
                </fieldset>
                <fieldset className="ad-form__element ad-form__element--time">
                    <label className="ad-form__label" for="timein">Время заезда и выезда</label>
                ...
                <fieldset className="ad-form__element">
                    <label className="ad-form__label" for="room_number">Кол-во комнат</label>
                ...
                <fieldset className="ad-form__element">
                    <label className="ad-form__label" for="capacity">Количество мест</label>
